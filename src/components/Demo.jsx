...
const Demo = () => {
    ...
    const[image, setImage] = useState('https://www.forex.academy/wp-content/uploads/2019/12/Blockchain-1.jpg');
    ...
    async function handleSubmit (event){
        ...
        const result = await contract.mint(encodedData);
    ...
    <div className='form-container'>
      ...
      <label className='l1'>
        ...
        {/* <label>
            ...
            <input 
            type='file' 
            accept='image/jpg, image/png, omage/jpeg'
            onChange = {(e)=>{
